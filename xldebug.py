...
ch=['অ', 'আ', 'ই', 'ঈ', 'উ', 'ঊ', 'ঋ', 'এ', 'ঐ', 'ও', 'ঔ', 'ক', 'খ', 'গ', 'ঘ', 'ঙ', 'চ', 'ছ', 'জ', 'ঝ', 'ঞ', 'ট', 'ঠ', 'ড', 'ঢ', 'ণ', 'ত', 'থ', 'দ', 'ধ', 'ন', 'প', 'ফ', 'ব', 'ভ', 'ম', 'য', 'র', 'ল', 'শ', 'ষ', 'স', 'হ', 'ড়', 'ঢ়', 'য়', 'ৎ', 'ং', 'ঃ', 'ঁ', ';', '”', '!', '।', '–', '=', '‘', '’', '[', ']', '*', '“', '?', '্ ', '/', ':', ', ', '.', '(', ')', 'া', 'ি', 'ী', 'ু', 'ূ', 'ৃ', 'ে', 'ৈ', 'ো', 'ৌ', 'ক্ষ', 'জ্ঞ', '2', '3', '4', '০', '১', '২', '৩', '৪', '৫', '৬', '৭', '৮', '৯', ' ']
...
wb = load_workbook('name_size_00 .xlsx')

# Get sheet names

sheet = wb['name_size_00']
anotherSheet = wb.active

i=1
print("enter row number")
for x in range(1,int(input())):
    word=sheet.cell(row=x, column=3).value
    #print(word)
    print(x)
    def split(word):
